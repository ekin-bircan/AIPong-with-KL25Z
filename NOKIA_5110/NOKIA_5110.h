...
class NokiaLcd
{
    ...
    public:
        ...
        void TestLcd2(char test_pattern); // added for eee212 project
        void SendDrawData(char data);
        
    public:
        void DrawString(char* str);
        void DrawString2(char* s);
        void DrawChar(char character);
        void SetXY(char x, char y);
        void drawRakets(int r1, int r2,int b1, int b2);
        void drawBall(int bx, int by);
        void print_win(int player, bool mode);
        void print_score(int s1, int s2, bool mode, int remaining, bool tmode);
...
const char FONT_6x6[285] = //should be 564 total char
{
 0x00, 0x00, 0x00, // SPACE   1   
 0x00, 0x06, 0x2F, // !   2
 0x00, 0x06, 0x00, // "   3
 0x14, 0x3E, 0x14, // #   4
 0x2E, 0x2A, 0x3F, // $   5
...
const char FONTS[570] = //should be 564 total char
{
